...
//               <Code size={40} className="text-purple-600" />
//               <motion.div
//                 animate={{ rotate: 360 }}
//                 transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
//                 className="absolute inset-0 border-2 border-dashed border-purple-300 rounded-full"
//               />
//             </div>
//           </motion.div>
...
//               >
//                 Hi, I'm Praveen Kukudala<span className="relative inline-block">
    ...
    <section className="min-h-screen relative overflow-hidden bg-gradient-to-b from-purple-50 via-white to-white">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
        <div className="flex items-center gap-8 md:gap-12">
          {/* Profile Image */}
          <motion.img
            src="/src/Assets/Praveen.jpg" // Replace with your actual image path
